            ...
            <div class="container">
                <div class="columns is-multiline">
                    ...
                    <div class="column is-4 right-image " data-aos="fade-left">
                        <img class="is-rounded" src="{{ asset('/assets/img/avatar/avatar.jpg') }}" width="100%"
                            height="100%" alt="" />
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="columns is-multiline" data-aos="fade-in-up" data-aos-easing="linear">
                    <div class="column is-12" style="text-align: -webkit-center;">
                        ...
                        <img class="is-rounded favicon-contact center-image" src="{{ asset('/assets/img/favicon.png') }}"
